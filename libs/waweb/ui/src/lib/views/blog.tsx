    ...
    <div className="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
        <div>
          ...
          <h3 className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-base-content-300 sm:text-4xl">
            Meet Whitney
          </h3>
        </div>
      </div>
      <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
        <div className="relative lg:row-start-1 lg:col-start-2">
          ...
          <div className="relative text-base mx-auto max-w-prose lg:max-w-none">
            <figure>
              ...
              <figcaption className="mt-3 flex text-sm text-base-content-700">
                <CameraIcon
                  className="flex-none w-5 h-5 text-base-content-700"
                  aria-hidden="true"
                />
        ...
        <div className="mt-8 lg:mt-0">
          <div className="text-base max-w-prose mx-auto lg:max-w-none">
            <p className="text-lg text-base-content-700">
          ...
          <div className="mt-5 prose prose-indigo text-base-content mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
            <p>
