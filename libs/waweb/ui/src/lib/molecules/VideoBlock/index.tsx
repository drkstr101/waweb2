import { VideoBlockModel } from '@watheia/model';
import { getVideoData } from '@watheia/utils';
import classNames from 'clsx';

export default function VideoBlock(props: VideoBlockModel) {
  if (!props.url) {
    return null;
  }
  ...
  return (
    <div
      id={cssId}
      className={classNames('wa-video-block', 'overflow-hidden relative w-full h-0', {
...
function videoEmbed(props: VideoBlockModel) {
