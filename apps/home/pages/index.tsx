        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8">
          <div className="max-w-md px-4 mx-auto sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
            <div className="lg:py-24">
              <a
                href="#features"
                className="inline-flex items-center p-1 pr-2 rounded-full text-base-content bg-base-300 sm:text-base-content lg:text-sm lg:text-base-content hover:text-neutral-content"
              >
                ...
                <ChevronRightIcon className="w-5 h-5 ml-2 text-primary" aria-hidden="true" />
              </a>
              <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 lg:text-6xl">
                <span className="block">A better way to</span>
                <span className="block text-accent">ship web apps</span>
              </h1>
              <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg lg:text-xl">
                  ...
                  <div className="sm:flex">
                    <div className="flex-1 min-w-0">
                      ...
                      <input
                        ...
                        className="block w-full px-4 py-3 text-base text-gray-900 placeholder-gray-500 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-300 focus:ring-offset-gray-900"
                      />
                    </div>
                    <div className="mt-3 sm:mt-0 sm:ml-3">
                      <button
                        type="submit"
                        className="block w-full px-4 py-3 font-medium text-white rounded-md shadow bg-accent hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-300 focus:ring-offset-gray-900"
                      >
                        Start free trial
                      </button>
                    </div>
          ...
          {features.map((feature) => (
            <div key={feature.name}>
              <dt>
                ...
                <p className="mt-5 text-lg font-medium leading-6 text-base-content-300">
                  {feature.name}
                </p>
              </dt>
          ...
          <div className="inline-flex rounded-md shadow">
            <Link href="/contact">
              <a className="inline-flex items-center justify-center px-5 py-3 text-base font-medium border border-transparent rounded-md bg-base-content hover:bg-base-content-300">
                Contact sales
                <ExternalLinkIcon
                  className="w-5 h-5 ml-3 -mr-1 text-primary"
                  aria-hidden="true"
                />
              </a>
            </Link>
