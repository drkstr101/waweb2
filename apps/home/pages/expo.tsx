  ...
  <div className="relative py-16 overflow-hidden">
    ...
    <div className="relative px-4 sm:px-6 lg:px-8">
      <div className="mx-auto text-lg prose max-w-prose">
        <h1>
          <span className="block text-base font-semibold tracking-wide text-center uppercase text-accent">
            Introducing
          </span>
          <span className="block mt-2 text-3xl font-extrabold leading-8 tracking-tight text-center text-base-content-300 sm:text-4xl">
            JavaScript for Beginners
          </span>
        </h1>
        <p className="mt-8 text-xl leading-8 text-base-content">
      ...
      <div className="mx-auto mt-6 prose prose-lg prose-indigo text-base-content">
        <p>
