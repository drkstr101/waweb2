    ...
    <div className="relative px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div className="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
        <div>
          ...
          <h3 className="mt-2 text-3xl font-extrabold leading-8 tracking-tight text-base-content-300 sm:text-4xl">
            Meet Whitney
          </h3>
        </div>
      </div>
      <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
        <div className="relative lg:row-start-1 lg:col-start-2">
          ...
          <div className="relative mx-auto text-base max-w-prose lg:max-w-none">
            <figure>
              ...
              <figcaption className="flex mt-3 text-sm text-base-content-700">
                <CameraIcon
        ...
        <div className="mt-8 lg:mt-0">
          ...
          <div className="mx-auto mt-5 prose prose-indigo text-base-content lg:max-w-none lg:row-start-1 lg:col-start-1">
            <p>
